...
repos=$(curl -ks -u ${DTR_USER}:${TOKEN} -X GET "https://${DTR_HOSTNAME}/api/v0/repositories?pageSize=100000&count=true" -H "accept: application/json" | jq -r -c .repositories)
...
while IFS= read -r row ; do
    ...
    tag_headers=$(curl -ks -I -u ${DTR_USER}:$TOKEN -X GET "https://$DTR_HOSTNAME/api/v0/repositories/${namespace}/${reponame}/tags?pageSize=1&count=true")
